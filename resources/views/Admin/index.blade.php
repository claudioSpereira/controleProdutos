        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="/main"><i class="fa fa-edit "></i>Meu Main  <span class="badge">Included</span></a>
                    </li>

                     <li>
                        <a href="criacolaborador"><i class="fa fa-edit "></i>Cria Colaborador </a>
                    </li>
                    <li>
                       <a href="/listacolaborador"><i class="fa fa-edit "></i>Lista Colaborador </a>
                   </li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-10 col-md-2 col-sm-2 col-xs-2">
